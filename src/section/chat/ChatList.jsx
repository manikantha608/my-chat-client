...
export default function ChatList() {
  ...
  return (
    <div className="hidden h-full flex-col xl:flex xl:w-1/4">
      <div className="sticky border-b boredr-stroke dark:border-strokedark px-6 py-7.5 flex flex-row ">
      ...
      <div className="flex max-h-full flex-col  p-5">
        <form className="sticky mb-2">
          <input
            placeholder="Search..."
            type="text"
            className="w-full rounded border border-stroke bg-gray-2 py-3 pl-5 pr-10 text-sm outline-none focus:border-primary dark:border-stroke dark:bg-boxdark-2"
          />
